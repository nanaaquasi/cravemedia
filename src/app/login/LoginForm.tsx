        ...
        {isWebView ? (
          <div className="rounded-xl bg-amber-500/10 border border-amber-500/20 p-4 space-y-3">
            <p className="text-sm text-amber-200/90">
              Google Sign-In doesn&apos;t work in this browser. Copy the link
              below and open it in Safari or Chrome to sign in.
            </p>
            <div className="flex gap-2">
              <input
                ...
                value={loginUrl}
                placeholder="Loading..."
                className="flex-1 min-w-0 bg-black/40 border border-white/10 rounded-lg py-2 px-3 text-xs text-zinc-300 truncate"
              />
              <button
                type="button"
                onClick={async () => {
                ...
                disabled={!loginUrl}
                className="shrink-0 flex items-center gap-2 px-4 py-2 rounded-lg bg-amber-500/20 hover:bg-amber-500/30 disabled:opacity-50 disabled:cursor-not-allowed text-amber-200 font-medium text-sm transition-colors"
              >
                {copied ? (
                  "Copied!"
                ) : (
            ...
            {loginUrl && (
              <a
                ...
                className="flex items-center justify-center gap-2 w-full py-2 rounded-lg bg-white/5 border border-white/10 hover:bg-white/10 text-zinc-300 text-sm transition-colors"
              >
          ...
          <Link
            ...
            className="w-full bg-white/5 border border-white/10 text-zinc-200 font-medium py-2.5 rounded-xl hover:bg-white/10 transition-colors flex items-center justify-center gap-3 disabled:opacity-70 disabled:cursor-not-allowed"
          >
