...
export function CollectionCard({ collection }: CollectionCardProps) {
  ...
  return (
    <div className="group relative bg-zinc-900/50 backdrop-blur-md border border-white/5 rounded-3xl p-4 hover:bg-zinc-800/50 transition-all cursor-pointer overflow-hidden">
